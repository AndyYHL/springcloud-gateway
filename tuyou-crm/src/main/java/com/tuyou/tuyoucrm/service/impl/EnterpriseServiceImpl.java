package com.tuyou.tuyoucrm.service.impl;
...
import com.tuyou.tuyoucrm.common.CommonConstant;
import com.tuyou.tuyoucrm.dao.EnterpriseMapper;
...
public class EnterpriseServiceImpl implements EnterpriseService {
	...
	public List<Enterprise> search(Enterprise entity, int pageIndex, int pageSize, String sort){
		...
		sort = StringUtils.isBlank(sort) ? " ctime desc " : sort;
